      ...
      <div className="flex-1 flex flex-col relative transition-all duration-300">
        ...
        <div className="w-full max-w-full sm:max-w-2xl fixed bottom-0 left-1/2 transform -translate-x-1/2 px-2 pb-[calc(1.5rem+env(safe-area-inset-bottom))] z-20">
          <div className="flex flex-row items-end gap-2 w-full">
            <textarea
              ref={textareaRef}
              className="flex-1 rounded-3xl px-4 py-3 resize-none overflow-hidden focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm bg-gray-900 text-white placeholder:white/60 min-h-[48px] text-center placeholder:text-center flex items-center justify-center"
              placeholder={
